 ...
 */
package com.acn.ai.cockpits.setup;
...
import com.acn.ai.cockpits.constants.AiCockpitsConstants;
 ...
 */
@SystemSetup(extension = AiCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(AiCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(AiCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						AiCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/aicockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
