 ...
 */
package com.acn.ai.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(AiFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(AiFulfilmentProcessConstants.PARENT_PROCESS);
