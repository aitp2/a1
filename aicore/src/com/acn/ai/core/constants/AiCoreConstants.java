 ...
 */
package com.acn.ai.core.constants;

/**
 * Global class for all AiCore constants. You can add global constants for your extension into this class.
 */
public final class AiCoreConstants extends GeneratedAiCoreConstants
{
	public static final String EXTENSIONNAME = "aicore";


	private AiCoreConstants()
	{
		//empty
	}
