...
public class DefaultAiutilService implements AiutilService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultAiutilService.class);
	...
	{
		return DefaultAiutilService.class.getResourceAsStream("/aiutil/sap-hybris-platform.png");
	}
