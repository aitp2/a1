...
/**
 * This is the extension manager of the Aiutil extension.
 */
public class AiutilManager extends GeneratedAiutilManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(AiutilManager.class);
	 ...
	 */
	public static AiutilManager getInstance()
	{
		return (AiutilManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(AiutilConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public AiutilManager() // NOPMD 
	{
		LOG.debug("constructor of AiutilManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of AiutilManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of AiutilManager called, current tenant: {}", getTenant().getTenantID());
	}
