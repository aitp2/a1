 ...
 */
package com.accenture.aitp.test.setup;
...
import com.accenture.aitp.test.constants.AitpTestConstants;
import com.accenture.aitp.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = AitpTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/aitptest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/aitptest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/aitptest/import/cstickets.impex");
			...
			importImpexFile(context, "/aitptest/import/csquotes.impex");
		}
	}
}
