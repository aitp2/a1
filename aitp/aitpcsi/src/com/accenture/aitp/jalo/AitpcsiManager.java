 ...
 */
package com.accenture.aitp.jalo;
...
import com.accenture.aitp.constants.AitpcsiConstants;



/**
 * This is the extension manager of the Aitpcsi extension.
 */
public class AitpcsiManager extends GeneratedAitpcsiManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(AitpcsiManager.class.getName());
	 ...
	 */
	public static AitpcsiManager getInstance()
	{
		return (AitpcsiManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				AitpcsiConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public AitpcsiManager() 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of AitpcsiManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of AitpcsiManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of AitpcsiManager called, current tenant: " + getTenant().getTenantID());
		}
	}
