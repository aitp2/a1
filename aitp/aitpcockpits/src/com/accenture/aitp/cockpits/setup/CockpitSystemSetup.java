 ...
 */
package com.accenture.aitp.cockpits.setup;
...
import com.accenture.aitp.cockpits.constants.AitpCockpitsConstants;
 ...
 */
@SystemSetup(extension = AitpCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(AitpCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(AitpCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						AitpCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/aitpcockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
