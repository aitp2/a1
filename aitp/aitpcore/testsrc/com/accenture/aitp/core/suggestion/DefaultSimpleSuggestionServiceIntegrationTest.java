 ...
 */
package com.accenture.aitp.core.suggestion;
...
import com.accenture.aitp.core.suggestion.impl.DefaultSimpleSuggestionService;
...
public class DefaultSimpleSuggestionServiceIntegrationTest extends ServicelayerTransactionalTest
{
	...
	{
		importCsv("/aitpcore/test/testSimpleSuggestionService.csv", "utf-8");
	}
