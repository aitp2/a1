...
import com.accenture.aitp.constants.AitpbackofficeConstants;
 ...
 */
public class AitpbackofficeManager extends GeneratedAitpbackofficeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(AitpbackofficeManager.class.getName());
	 ...
	 */
	public static AitpbackofficeManager getInstance()
	{
		return (AitpbackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(AitpbackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public AitpbackofficeManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of AitpbackofficeManager called.");
		}
	}
