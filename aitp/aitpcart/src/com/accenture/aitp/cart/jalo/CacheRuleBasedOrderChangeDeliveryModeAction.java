...
public class CacheRuleBasedOrderChangeDeliveryModeAction extends GeneratedCacheRuleBasedOrderChangeDeliveryModeAction
		implements JaloOnlyItem
{
	@SuppressWarnings("unused")
	private final static Logger LOG = Logger.getLogger(CacheRuleBasedOrderChangeDeliveryModeAction.class.getName());
			...
			throws JaloBusinessException
	{
		...
		try
		{
			final CacheRuleBasedOrderChangeDeliveryModeAction e = (CacheRuleBasedOrderChangeDeliveryModeAction) cl.newInstance();
