...
public class CacheRuleBasedSplitNormalEntryAction extends GeneratedCacheRuleBasedSplitNormalEntryAction implements JaloOnlyItem
{
	@SuppressWarnings("unused")
	private final static Logger LOG = Logger.getLogger(CacheRuleBasedSplitNormalEntryAction.class.getName());
			...
			throws JaloBusinessException
	{
		...
		try
		{
			final CacheRuleBasedSplitNormalEntryAction e = (CacheRuleBasedSplitNormalEntryAction) cl.newInstance();
