...
public class CacheRuleBasedOrderAdjustTotalAction extends GeneratedCacheRuleBasedOrderAdjustTotalAction implements JaloOnlyItem
{
	@SuppressWarnings("unused")
	private final static Logger LOG = Logger.getLogger(CacheRuleBasedOrderAdjustTotalAction.class.getName());
			...
			throws JaloBusinessException
	{
		...
		try
		{
			final CacheRuleBasedOrderAdjustTotalAction e = (CacheRuleBasedOrderAdjustTotalAction) cl.newInstance();
	...
	{
		return this.data.getProperty(ctx, AMOUNT);
	}
