...
public class CacheRuleBasedOrderEntryAdjustAction extends GeneratedCacheRuleBasedOrderEntryAdjustAction implements JaloOnlyItem
{
	@SuppressWarnings("unused")
	private final static Logger LOG = Logger.getLogger(CacheRuleBasedOrderEntryAdjustAction.class.getName());
			...
			throws JaloBusinessException
	{
		...
		try
		{
			final CacheRuleBasedOrderEntryAdjustAction e = (CacheRuleBasedOrderEntryAdjustAction) cl.newInstance();
