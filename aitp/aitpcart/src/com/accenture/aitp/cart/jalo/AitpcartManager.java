...
/**
 * This is the extension manager of the Aitpcart extension.
 */
public class AitpcartManager extends GeneratedAitpcartManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(AitpcartManager.class);
	 ...
	 */
	public static AitpcartManager getInstance()
	{
		return (AitpcartManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(AitpcartConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public AitpcartManager() // NOPMD 
	{
		LOG.debug("constructor of AitpcartManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of AitpcartManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of AitpcartManager called, current tenant: {}", getTenant().getTenantID());
	}
