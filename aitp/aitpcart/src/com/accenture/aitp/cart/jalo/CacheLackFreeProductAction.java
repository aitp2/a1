...
public class CacheLackFreeProductAction extends GeneratedCacheLackFreeProductAction implements JaloOnlyItem
{
	@SuppressWarnings("unused")
	private final static Logger LOG = Logger.getLogger(CacheLackFreeProductAction.class.getName());
			...
			throws JaloBusinessException
	{
		...
		try
		{
			final CacheLackFreeProductAction e = (CacheLackFreeProductAction) cl.newInstance();
