...
public class CacheRuleBasedAddCouponAction extends GeneratedCacheRuleBasedAddCouponAction implements JaloOnlyItem
{
	@SuppressWarnings("unused")
	private final static Logger LOG = Logger.getLogger(CacheRuleBasedAddCouponAction.class.getName());
			...
			throws JaloBusinessException
	{
		...
		try
		{
			final CacheRuleBasedAddCouponAction e = (CacheRuleBasedAddCouponAction) cl.newInstance();
