...
public class CacheRuleBasedPotentialPromotionMessageAction extends GeneratedCacheRuleBasedPotentialPromotionMessageAction
		implements JaloOnlyItem
{
	@SuppressWarnings("unused")
	private final static Logger LOG = Logger.getLogger(CacheRuleBasedPotentialPromotionMessageAction.class.getName());
			...
			throws JaloBusinessException
	{
		...
		try
		{
			final CacheRuleBasedPotentialPromotionMessageAction e = (CacheRuleBasedPotentialPromotionMessageAction) cl.newInstance();
