...
public class CacheRuleBasedOrderEntryRebateAction extends GeneratedCacheRuleBasedOrderEntryRebateAction implements JaloOnlyItem
{
	@SuppressWarnings("unused")
	private final static Logger LOG = Logger.getLogger(CacheRuleBasedOrderEntryRebateAction.class.getName());
			...
			throws JaloBusinessException
	{
		...
		try
		{
			final CacheRuleBasedOrderEntryRebateAction e = (CacheRuleBasedOrderEntryRebateAction) cl.newInstance();
