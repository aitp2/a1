...
public class CacheRuleBasedAdjustOrderEntryQuantityAction extends GeneratedCacheRuleBasedAdjustOrderEntryQuantityAction
		implements JaloOnlyItem
{
	@SuppressWarnings("unused")
	private final static Logger LOG = Logger.getLogger(CacheRuleBasedAdjustOrderEntryQuantityAction.class.getName());
			...
			throws JaloBusinessException
	{
		...
		try
		{
			final CacheRuleBasedAdjustOrderEntryQuantityAction e = (CacheRuleBasedAdjustOrderEntryQuantityAction) cl.newInstance();
