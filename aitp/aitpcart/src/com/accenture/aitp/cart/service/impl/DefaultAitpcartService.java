...
public class DefaultAitpcartService implements AitpcartService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultAitpcartService.class);
	...
	{
		return DefaultAitpcartService.class.getResourceAsStream("/aitpcart/sap-hybris-platform.png");
	}
