 ...
 */
package com.accenture.aitp.tailor.jalo;
...
/**
 * This is the extension manager of the Aitptailor extension.
 */
public class AitptailorManager extends GeneratedAitptailorManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(AitptailorManager.class);
	 ...
	 */
	public static AitptailorManager getInstance()
	{
		return (AitptailorManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(AitptailorConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public AitptailorManager() // NOPMD 
	{
		LOG.debug("constructor of AitptailorManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of AitptailorManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of AitptailorManager called, current tenant: {}", getTenant().getTenantID());
	}
