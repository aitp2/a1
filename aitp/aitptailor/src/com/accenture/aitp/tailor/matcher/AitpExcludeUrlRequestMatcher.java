 ...
 * will return true.
 */
public class AitpExcludeUrlRequestMatcher implements RequestMatcher
{
	private static final Logger LOG = Logger.getLogger(AitpExcludeUrlRequestMatcher.class);
