...
public class DefaultAitptailorService implements AitptailorService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultAitptailorService.class);
	...
	{
		return DefaultAitptailorService.class.getResourceAsStream("/aitptailor/sap-hybris-platform.png");
	}
