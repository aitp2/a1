 ...
 *
 */
public class DefaultAitpModelMonitorQueueStrategImpl implements AitpModelMonitorQueueStrateg
{
	private final static Logger LOG = Logger.getLogger(DefaultAitpModelMonitorQueueStrategImpl.class);
