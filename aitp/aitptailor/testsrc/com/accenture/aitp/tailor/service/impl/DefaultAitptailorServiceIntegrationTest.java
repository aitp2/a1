...
import com.accenture.aitp.tailor.service.impl.DefaultAitptailorService;
 ...
 */
@IntegrationTest
public class DefaultAitptailorServiceIntegrationTest extends ServicelayerBaseTest
{
	@Resource
	...
	{
		// given
		final String logoCode = "aitptailorPlatformLogo";

		// when
		final String logoUrl = aitptailorService.getHybrisLogoUrl(logoCode);
