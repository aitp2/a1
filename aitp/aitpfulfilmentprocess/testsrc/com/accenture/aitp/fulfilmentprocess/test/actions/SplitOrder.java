 ...
 */
package com.accenture.aitp.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(AitpFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(AitpFulfilmentProcessConstants.PARENT_PROCESS);
