 ...
 */
package com.accenture.aitp.fulfilmentprocess.test.actions.consignmentfulfilment;
...
public abstract class AbstractTestConsActionTemp extends TestActionTemp
{
	...
	{
		final String parentCode = (String) getProcessParameterValue(process, AitpFulfilmentProcessConstants.PARENT_PROCESS);
