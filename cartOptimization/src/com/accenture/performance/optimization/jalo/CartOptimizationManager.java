 ...
 */
package com.accenture.performance.optimization.jalo;
...
/**
 * This is the extension manager of the CartOptimization extension.
 */
public class CartOptimizationManager extends GeneratedCartOptimizationManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(CartOptimizationManager.class);
	 ...
	 */
	public static CartOptimizationManager getInstance()
	{
		return (CartOptimizationManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(CartOptimizationConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public CartOptimizationManager() // NOPMD 
	{
		LOG.debug("constructor of CartOptimizationManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of CartOptimizationManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of CartOptimizationManager called, current tenant: {}", getTenant().getTenantID());
	}
