...
public class DefaultCartOptimizationService implements CartOptimizationService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultCartOptimizationService.class);
	...
	{
		return DefaultCartOptimizationService.class.getResourceAsStream("/cartOptimization/sap-hybris-platform.png");
	}
