...
<html>
<head>
    <title>Welcome to cartOptimization</title>
    <link rel="stylesheet" href="<c:url value="/static/cartOptimization-webapp.css"/>" type="text/css"
          media="screen, projection"/>
</head>
<div class="container">
    <img src="<c:url value="${logoUrl}" />" alt="Hybris platform logo"/>

    <h2>Welcome to "cartOptimization" extension</h2>
    ...
    <div>
        ...
        <ul>
            <li><b>resources/cartOptimization-items.xml</b> - here you can model your items</li>
            <li><b>resources/cartOptimization-spring.xml</b> - here you can define your services</li>
            <li><b>web/webroot/WEB-INF/config/cartOptimization-spring-mvc-config.xml</b> - here is a Spring MVC related
                configuration
            </li>
            <li><b>web/webroot/WEB-INF/config/cartOptimization-web-app-config.xml</b> - here you can define web related services,
                facades etc.
            </li>
            <li><b>web/webroot/WEB-INF/config/cartOptimization-spring-security-config.xml</b> - here you can configure your Spring Security settings</li>
