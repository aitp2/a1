...
import com.accenture.performance.optimization.service.impl.DefaultCartOptimizationService;
 ...
 */
@IntegrationTest
public class DefaultCartOptimizationServiceIntegrationTest extends ServicelayerBaseTest
{
	@Resource
	...
	{
		// given
		final String logoCode = "cartOptimizationPlatformLogo";

		// when
		final String logoUrl = cartOptimizationService.getHybrisLogoUrl(logoCode);
